        ...
        <div class="col-md-4">
            <div class="row">
                ...
                <div class="col-12">
                    ...
                    <br>
                    <strong>Email: </strong><a href="mailto:info@newssite.com" class="text-white">info@newssite.com"</a><br>
                    <strong>Phone No.: </strong><a href="tel:9876543212" class="text-white">9876543212</a><br>
                </div>
            </div>
        </div>
        <div class="col-md-4">
            ...
            <div class="row">
                ...
                <div class="col-12">
                    <form method="post" action="<?php echo url('message'); ?>">
                        ...
                        <div class="form-group">
                            <button type="text" name="submit" class="btn btn-outline-light"> <i class="fas fa-paper-plane mr-2"></i> Send </button>
                        </div>
                    </form>
                </div>
            </div>
