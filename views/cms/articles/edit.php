                ...
                <div class="col-6 mx-auto">
                    <form action="<?php echo url('articles/update/'.$article->id); ?>" method="post">
                        ...
                        <div class="form-group">
                            ...
                            <textarea name="content" id="content" class="form-control" value="<?php echo $article->content;?>"  required>"</textarea>
                        </div>

                        <div class="form-group">
                            <label for="featured_image">Featured Image</label>
                            <input type="file" name="featured_image" id="featured_image" class="form-control" accept="image/*" value="<?php echo $article->featured_image ;?>" required>
                            <br><br>
                            <button type="submit">Submit</button>
                        </div>
                        <div class="form-group">
                            <label for="category_id">Category Id</label>
                            <input type="text" name="category_id" id="category_id" class="form-control" value="<?php echo $article->category_id;?>"required>
                        </div>
                        <div class="form-group">
